  ...
  return (
    <form ref={formRef} action={formAction} className="mt-6 space-y-4">
      <label className="block">
        ...
        <Input name="name" placeholder="CommitGlow" minLength={2} maxLength={80} required />
      </label>
      <label className="block">
        <span className="mb-2 block font-mono text-xs uppercase tracking-[0.14em] text-zinc-500">Description</span>
        <Input name="description" placeholder="Optional product or workspace note" maxLength={160} />
      </label>
      <SubmitButton />
