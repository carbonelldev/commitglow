    ...
    <AuthShell>
      {session ? (
        <div className="w-full max-w-md rounded-md border border-violet-300/30 bg-black/50 p-6">
          ...
          <h1 className="mt-4 font-mono text-3xl text-white">You already have a session.</h1>
          <p className="mt-4 font-mono text-sm leading-7 text-zinc-400">Continue as {session.user.email} instead of creating another account.</p>
